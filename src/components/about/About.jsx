  ...
  <Row>
    ...
    <Col xs={9}>
      ...
      <p>
        ...
        administration. I love learning new technologies and ways of doing things. I am constantly
        trying to do new things to improve my skills and broaden my horizons. This website is about
        my musings, personal interests, and projects.
      </p>
    </Col>
  </Row>;
